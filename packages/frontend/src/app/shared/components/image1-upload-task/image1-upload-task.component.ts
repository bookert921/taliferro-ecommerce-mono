...
@Component({
  selector: 'app-image1-upload-task',
  templateUrl: './image1-upload-task.component.html',
  styleUrls: ['./image1-upload-task.component.css']
})
export class Image1UploadTaskComponent implements OnInit, OnDestroy {
