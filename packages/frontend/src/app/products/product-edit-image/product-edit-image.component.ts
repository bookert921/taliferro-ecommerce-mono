...
@Component({
  selector: 'app-product-edit-image',
  templateUrl: './product-edit-image.component.html',
  styleUrls: ['./product-edit-image.component.css']
})
export class ProductEditImageComponent implements OnInit, OnDestroy {
  ...
  onAdd(): void {
    try {
      this._dataService.add(environment.PRODUCTS, this.data).then((result) => {
